...
namespace Allinone
{
    ...
    class INI
    {
        ...
        public static bool bUseFastTest = false;//开启边走边测试 但是结果测试可能有问题 目前无法修改
        ...
        public static void Load()
        {
            ...
            bUseFastTest = ReadINIValue("Basic Control", "bUseFastTest", "0", INIFILE) == "1";
        ...
        public static void Save()
        {
            ...
            WriteINIValue("Basic Control", "bUseFastTest", (bUseFastTest ? "1" : "0"), INIFILE);

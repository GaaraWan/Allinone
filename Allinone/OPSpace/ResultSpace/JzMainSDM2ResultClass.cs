...
{
    public class JzMainSDM2ResultClass : GeoResultClass
    {
        ...
        public JzMainSDM2ResultClass(Result_EA resultea, VersionEnum version, OptionEnum option, MachineCollectionClass machinecollection)
        {
            myResultEA = resultea;
            VERSION = version;
            OPTION = option;
            ...
            MACHINE = (JzMainSDM2MachineClass)machinecollection.MACHINE;

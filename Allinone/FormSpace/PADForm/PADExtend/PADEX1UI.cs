...
{
    public partial class PADEX1UI : UserControl
    {

        //bool mCropRegion = false;
        Bitmap bmpOperate = new Bitmap(1, 1);
        PADExtendClass  pADExtend = new PADExtendClass();
        ...
        private void Pg_PropertyValueChanged(object s, PropertyValueChangedEventArgs e)
        {
            switch (e.ChangedItem.Label)
            {
                ...
                case "05b.碰触元件外扩Y":
                    ...
                    analyze.PADPara.PADExtendOPString = GetDataValueString();
        ...
        {
            string retstring = "";
            retstring = pADExtend.ToParaString();
            return retstring;
        }

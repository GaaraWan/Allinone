...
{
    public partial class N1UI : UserControl
    {
        ...
        public string GetDataValueString()
        {
            ...
            retstring = n1Class.ToParaString();
        ...
        private void DS1_CaptureAction(RectangleF rectf)
        {
            ...
            if (mCropRegion)
            {
                ...
                if (rectf.Width > 1 && rectf.Height > 1)
                {
                    ...
                    analyze.PADPara.ChipNoHaveModeOpString = GetDataValueString();
                    bool bOK = analyze.PADPara.checkNoHaveRun(bmp0);

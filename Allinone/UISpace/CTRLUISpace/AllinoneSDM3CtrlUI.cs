...
{
    public partial class AllinoneSDM3CtrlUI : UserControl
    {
        enum TagEnum
        {
            TOPLIGHT,
        ...
        public void Initial(VersionEnum version, OptionEnum option, JzMainSDM3MachineClass machine)
        {
            VERSION = version;
            OPTION = option;
            MACHINE = machine;

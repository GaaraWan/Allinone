...
namespace Allinone.ControlSpace.IOSpace
{
    ...
    public class JzR9IOClass : GeoIOClass
    {
        ...
        public override void LoadData()
        {
            ...
            ADDRESSARRAY[(int)R15AddressEnum.ADR_ISSTOP] = new FATEKAddressClass(ReadINIValue("Status Address", R15AddressEnum.ADR_ISSTOP.ToString(), "", INIFILE));
            ...
            ADDRESSARRAY[(int)R15AddressEnum.ADR_STILTSLIGHT] = new FATEKAddressClass(ReadINIValue("Operation Address", R15AddressEnum.ADR_STILTSLIGHT.ToString(), "", INIFILE));
        ...
        public bool IsStop
        {
            get
            {
                FATEKAddressClass address = ADDRESSARRAY[(int)R15AddressEnum.ADR_ISSTOP];
                return PLC[address.SiteNo].IOData.GetBit(address.Address0);
            }
        }
        ...
        public bool StiltsLight
        {
            get
            {
                FATEKAddressClass address = ADDRESSARRAY[(int)R9AddressEnum.ADR_STILTSLIGHT];

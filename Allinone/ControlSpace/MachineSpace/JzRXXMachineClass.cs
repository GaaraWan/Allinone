...
{
    public class JzRXXMachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public JzRXXIOClass PLCIO;
        public JzHiveClass HIVECLIENT
        {
            get { return Universal.JZHIVECLIENT; }
        }
        public JzRXXMachineClass(Machine_EA machineea, VersionEnum version, OptionEnum option,string opstr,string workpath,bool isnouseplc)
        {

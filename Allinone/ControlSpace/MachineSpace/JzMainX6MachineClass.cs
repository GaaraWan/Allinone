...
{
    public class JzMainX6MachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public JzMainX6IOClass PLCIO;

        public JzMainX6MachineClass(Machine_EA machineea, VersionEnum version, OptionEnum option, CameraActionMode actionMode, string opstr, string workpath, bool isnouseplc)
        {

...
{
    public class JzR1MachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public JzR1IOClass PLCIO;
        public JzHiveClass HIVECLIENT
        {
            get { return Universal.JZHIVECLIENT; }
        }
        public JzR1MachineClass(Machine_EA machineea, VersionEnum version, OptionEnum option,string opstr,string workpath,bool isnouseplc)
        {

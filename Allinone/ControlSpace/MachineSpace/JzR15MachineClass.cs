...
{
    public class JzR15MachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public JzR15IOClass PLCIO;
        public JzHiveClass HIVECLIENT
        {
            get { return Universal.JZHIVECLIENT; }
        }
        public JzR15MachineClass(Machine_EA machineea, VersionEnum version, OptionEnum option,string opstr,string workpath,bool isnouseplc)
        {

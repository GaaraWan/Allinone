...
{
    public class JzR9MachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public JzR9IOClass PLCIO;
        public JzHiveClass HIVECLIENT
        {
            get { return Universal.JZHIVECLIENT; }
        }
        public JzR9MachineClass(Machine_EA machineea, VersionEnum version, OptionEnum option,string opstr,string workpath,bool isnouseplc)
        {

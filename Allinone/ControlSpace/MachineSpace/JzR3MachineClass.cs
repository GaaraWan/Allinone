...
{
    public class JzR3MachineClass : GeoMachineClass
    {
        const int MSDuriation = 10;

        public JzR3IOClass PLCIO;
        public JzHiveClass HIVECLIENT
        {
            get { return Universal.JZHIVECLIENT; }
        }
        public JzR3MachineClass(Machine_EA machineea, VersionEnum version, OptionEnum option,string opstr,string workpath,bool isnouseplc)
        {

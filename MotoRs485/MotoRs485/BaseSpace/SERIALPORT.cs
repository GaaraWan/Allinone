...
namespace MotoRs485.BaseSpace
{
    ...
    public class SERIALPORT
    {
      ...
      public  SerialPort mSerial = new SerialPort();
        ...
        /// 需要重复发送的指令
        /// </summary>
      public  byte[] SendByteToRepeat;
        /// <summary>
        /// 是否重复发送这条指令
        /// </summary>
        public bool isRepeat = false;

        Stopwatch WatchRepeat = new Stopwatch();
        #endregion
        #region 初始化
        ...
        public void SendData()
        {
            ...
            if(isRepeat && WatchRepeat.ElapsedMilliseconds>60)
            {
                SendBytes = SendByteToRepeat;
                WriteCOM(SendByteToRepeat);
                WatchRepeat.Restart();
                return;
            }
           //优先发送
        ...
        public void ADDSendByteToRepeat(byte[] value)
        {
            WatchRepeat.Restart();
            SendByteToRepeat = value;
        }

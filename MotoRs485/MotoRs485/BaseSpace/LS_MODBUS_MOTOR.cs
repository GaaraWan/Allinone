...
namespace MotoRs485.BaseSpace
{
    ...
    public class LS_MODBUS_MOTOR
    {
        ...
        enum RegisterEnum : int
        {
            ...
            /// 目标速度
            /// </summary>
            MotorObjectSpeed = 0x6203,
            /// <summary>
            /// 加速度
            /// </summary>
            MotorAcceleration = 0x6204,
            /// <summary>
            /// 减速度
            /// </summary>
            MotorDeceleration = 0x6205,
            /// <summary>
            /// 回零模式
            /// </summary>
            MotorHomeMode = 0x600A,
            /// <summary>
            /// 回零高速
            /// </summary>
            MotorHomeSpeed_HI = 0x600F,
            /// <summary>
            /// 回零低速
            /// </summary>
            MotorHomeSpeed_LO = 0x6010,
            /// <summary>
            /// 回零加速
            /// </summary>
            MotorHomeAddSubtract = 0x6011,
            /// <summary>
            /// 回零减速
            /// </summary>
            MotorHomeCutSubtract = 0x6012,

            /// <summary>
            /// 电机控制触发寄存器
            /// </summary>
            MotorControl2 = 0x1801,
            /// <summary>
            /// 电机触发寄存器
            /// </summary>
            MotorControl = 0x6002,
            ...
            /// 马达现在的位置(32位)地址
            /// </summary>
            MotorPositionNow = 0x602C,
            /// <summary>
            /// 目标位置(32位  0x6201高位 0x6202低位)
            /// </summary>
            MotorObjectPosition = 0x6201,


            /// <summary>
            /// 马达错误信息
            /// </summary>
            MotorErrorCode = 0x2203,
            /*
故障码 内容
0x01 过流
0x02 过压
...
0x100 参数自整定故障
        ...
        public enum MotoFunction
        {
            ...
            /// 复位历史报警
            /// </summary>
            ResetHistoricalAlert = 0x1122,
            /// <summary>
            /// 保存所有参数到 EEPROM
            /// </summary>
            SaveParToEEPROM = 0x2211,
            /// <summary>
            /// 参数初始化
            /// </summary>
            InitialiPar = 0x2222,
        ...
        /// 厂商及型号
        /// </summary>
        public string MotorModel { get; private set; } = "";
        /// <summary>
        /// 硬件版本
        /// </summary>
        public string MotorVersionHardware { get; private set; } = "";
        /// <summary>
        /// 软件版本
        /// </summary>
        public string MotorVersionSoftware { get; private set; }
        /// <summary>
        /// 马达错误信息
        /// </summary>
        public string MotorError { get; private set; }
        /// <summary>
        /// 目标速度
        /// </summary>
        ...
        /// 现在的速度
        /// </summary>
        public int MotorSpeedNow { get; private set; } = -1;
        /// <summary>
        /// 马达现在的位置
        /// </summary>
        public int MotorPositionNow { get; private set; } = -1;
        /// <summary>
        /// 电机状态
        /// </summary>
        public LS_MotorState MotorStateNow { get; private set; } = new LS_MotorState();
        /// <summary>
        /// 马达加速度
        /// </summary>
        ...
        public LS_MODBUS_MOTOR(byte iPro, string INIAddress, bool isDebug)
        {
            PRO = iPro;
        ...
        public LS_MODBUS_MOTOR(byte iPro, SERIALPORT motor)
        {
            PRO = iPro;
            mSERIALPORT = motor;
            Initial();
                    ...
                    if (e.MyData[0] == PRO)
                    {
                        ...
                        switch (temp)
                        {
                            ...
                            case RegisterEnum.MotorState:
                                ...
                                if (strTemp.Length > 1 && strTemp.Length < 10)
                                    strTemp = Convert.ToString(Convert.ToInt32(strTemp, 16), 2).PadLeft(8, '0');
                                ToMotorState(strTemp);
                                break;
                            case RegisterEnum.MotorInputIO:
                                strTemp = "";
                                for (int i = 0; i < byteArray.Length; i++)
                                    strTemp += byteArray[i].ToString("X2");
        ...
        void MotorInitial()
        {
            ...
            mHomeMode = MotorHomeModeCodeEnum.Mode0;
            //MotorOperationMODE = MotorOperationModeEnum.PositionMODE;
     ...
     */
            ...
            LS_MotorState state = MotorStateNow;

            state.ISAlert = chars[0] == '1';
            state.ISEnable = chars[1] == '1';
            state.ISRuning = chars[2] == '1';
            state.ISCODEOK = chars[4] == '1';
            state.ISGoOK = chars[5] == '1';
            state.ISHomeOK = chars[6] == '1';
            MotorStateNow = state;
        }
        /// <summary>
        /// 二进制转成MotorState
        /// </summary>
        /// <param name="strData"></param>
        void ToMotorInputIO(string strData)
        {
            char[] chars = strData.ToCharArray();
            Array.Reverse(chars);
            // string newstr = new string(chars);
          ...
          //  state.ISAlert = chars[0] == '1';
            state.ISCW = chars[1] == '1';
            state.ISCCW = chars[2] == '1';
            state.ISHome = chars[1] == '1';
            MotorStateNow = state;
        }
        ...
        void GetInPutIO()
        {
            ...
            sendtemp.myPRO = PRO;
            sendtemp.myFunctionCode = FunctionCodeEnum.MultipleReads;
            sendtemp.myRegister = RegisterEnum.MotorInputIO;
            sendtemp.mySendDataNumber = 0x0001;
        ...
        void GetHomeSpeed()
        {
            ...
            sendtemp.myPRO = PRO;
            sendtemp.myFunctionCode = FunctionCodeEnum.MultipleReads;
            sendtemp.myRegister = RegisterEnum.MotorHomeSpeed_HI;
            sendtemp.mySendDataNumber = 0x0002;
        ...
        /// 读取回零速度
        /// </summary>
        void SetHomeSpeed_Lo()
        {

            ModbusData sendtemp = new ModbusData();
            sendtemp.myPRO = PRO;
            sendtemp.myFunctionCode = FunctionCodeEnum.SingleWrite;
            sendtemp.myRegister = RegisterEnum.MotorHomeSpeed_LO;
            sendtemp.mySendDataNumber = 0x0000;
            //sendtemp.myDataList.Add(0);
            sendtemp.myDataList.Add(5);
        ...
        public void SetHomeMode(MotorHomeModeCodeEnum Mode)
        {
            ModbusData sendtemp = new ModbusData();
            sendtemp.myPRO = PRO;
            sendtemp.myFunctionCode = FunctionCodeEnum.SingleWrite;
        ...
        /// 功能 运行
        /// </summary>
        public void RunFunction(MotoFunction function)
        {
            if (function == MotoFunction.JOGLeft || function == MotoFunction.JOGRight)
                mSERIALPORT.isRepeat = true;
            // Reset();
            ModbusData sendtempControl = new ModbusData();
            sendtempControl.myPRO = PRO;
            sendtempControl.myFunctionCode = FunctionCodeEnum.SingleWrite;
            sendtempControl.myRegister = RegisterEnum.MotorControl2;
            sendtempControl.mySendDataNumber = 0x0000;
            sendtempControl.myDataList.Add((int)function);

            SENDDATA = sendtempControl;
            mSERIALPORT.ADDSendByteToRepeat(sendtempControl.GetSenddata);
        }
        ...
        public void RunHome()
        {
            ...
            sendtempControl.myRegister = RegisterEnum.MotorControl;
            sendtempControl.mySendDataNumber = 0x0000;
            sendtempControl.myDataList.Add(0x020);
            SENDDATA = sendtempControl;
        ...
        public void GoPosition()
        {
            ...
            sendtempControl.myRegister = RegisterEnum.MotorControl;
            sendtempControl.mySendDataNumber = 0x0000;
            sendtempControl.myDataList.Add(0x010);
            SENDDATA = sendtempControl;
    ...
    public class LS_MotorState
    {
        ...
        /// 是否回0完成
        /// </summary>
        public bool ISHomeOK { get; set; } = false;
        /// <summary>
        /// 是否指令完成
        /// </summary>
        public bool ISCODEOK { get; set; } = false;
        /// <summary>
        ///  路径完成
        /// </summary>
        public bool ISGoOK { get; set; } = false;
    }

    public class LS_MotorState2
    {
        /// <summary>
        /// 初始化是否准备好
        /// </summary>

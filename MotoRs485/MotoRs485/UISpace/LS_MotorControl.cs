...
{
    public partial class LS_MotorControl : UserControl
    {
        
        #region 申明变量
        BaseSpace.LS_ControlMotorClass mMotor;
        BaseSpace.LS_MotorState mState;
        Button btn_UP;
        Button btn_Down;
        Button btn_Home;
      ...
      //  Label lblMotorVersionSoftware;
        ...
        public LS_MotorControl()
        {
            InitializeComponent();
        }
        public void Initial(BaseSpace.LS_ControlMotorClass PAR)
        {
            mMotor = PAR;
            Loading();
        ...
        private void MyMoto_TRIGGERMESSIGE(object sender, BaseSpace.LS_MODBUS_MOTOR.MESSIGEEventArgs e)
        {
            switch(e.MyType)
            {
        ...
        private void btn_Down_MouseUp(object sender, MouseEventArgs e)
        {
         ...
         //   mMotor.Stop();
            ...
            mMotor. mSERIALPORT.isRepeat = false;

        }
        private void btn_Down_MouseDown(object sender, MouseEventArgs e)
        {
            btn_Down.BackColor = Color.Red;
            mMotor.RunFunction( BaseSpace.LS_MODBUS_MOTOR.MotoFunction.JOGLeft);
        }
        ...
        private void btn_UP_MouseDown(object sender, MouseEventArgs e)
        {
          ...
          //  mMotor.Corotation();
            mMotor.RunFunction(BaseSpace.LS_MODBUS_MOTOR.MotoFunction.JOGRight);
        }

...
namespace JetEazy.ControlSpace
{
    public class FatekPLCClass : COMClass
    {
            ...
            while (m_Running)
            {
                ...
                try
                {
                    if (master != null)
                    {
                        ...
                        //读取所有位置(MW 1400 ~1430)
                        int iMWAddress = 99;
                        ushort[] myReadMW = master.ReadInputRegisters(STATIONID, (ushort)iMWAddress, 10);
                        ...
                        int iIXAdress = 64;
                        myRead = master.ReadInputs((byte)STATIONID, (ushort)(iIXAdress * 8), (ushort)(64));
        ...
        public override void SetData_ushort(ushort data, string ioname)
        {
            if (string.IsNullOrEmpty(ioname))
                return;

...
{
    //public class FATEKAddressClass
    //{
    //    public int SiteNo = -1;
    //    public string Address0 = "";
    //    public string Address1 = "";

    //    public FATEKAddressClass(string str)
    //    {
    //        if (str.Trim() != "")
    //        {
    ...
    public class FATEKAddressClass
    {
        ...
        public FATEKAddressClass(string str, int eoffset)
        {
            if (str.Trim() != "")
            {
                Offset = eoffset;
        ...
        string CovertToNormalAddress(string str)
        {
            ...
            string ret = "";
            long addressvalue = 0;// long.Parse(str.Substring(1));

            if (!long.TryParse(str.Substring(1), out addressvalue))
                return CovertToNormalAddressHC_Q1_1300D(str);

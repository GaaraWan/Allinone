...
namespace JetEazy.PlugSpace.BarcodeEx
{
    ...
    public class Mvd2dCNNReader : IDisposable
    {
        ...
        public BarcodeCNNItem GetBarcodeItem = new BarcodeCNNItem();
        ~Mvd2dCNNReader()
        {
            Dispose();
        }
        public Mvd2dCNNReader()
        {
        ...
        string _cnnDecodeAndGrade(Bitmap ebmpInput, bool eGradeUse = false)
        {
            ...
            try
            {
                ...
                Code2DReaderTool.SetRunParam("PerfMode", "1");
